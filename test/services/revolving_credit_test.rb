...
class RotativoTest < ActiveSupport::TestCase
  ...
  test "canonical table: full projection to the centavo" do
    p = RevolvingCredit.projection(300_000, 45_000, revolving_monthly_rate: ROT, installment_monthly_rate: PARC)
  ...
  test "parcel helper matches the projection's displayed installment" do
    assert_equal 41_749, RevolvingCredit.parcel(295_076, monthly_rate: PARC)
  end

  test "no projection when nothing is financed (full payment or overpay)" do
    assert_nil RevolvingCredit.projection(300_000, 300_000, revolving_monthly_rate: ROT, installment_monthly_rate: PARC)
    assert_nil RevolvingCredit.projection(300_000, 310_000, revolving_monthly_rate: ROT, installment_monthly_rate: PARC)
  end
